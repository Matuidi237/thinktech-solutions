---
title: "Étude de cas : comment Bouka Creativ' Learning forme 42 000 jeunes au Cameroun"
description: "Retour sur le déploiement de la plateforme Bouka Creativ' Learning, conçue avec l'incubateur Boukarou pour la montée en compétences de la jeunesse camerounaise."
...
## Le défi : former à grande échelle, partout au Cameroun

Quand Boukarou nous a contactés, le besoin était clair mais exigeant : une plateforme capable d'accueillir un volume massif d'apprenants, dans des zones urbaines comme rurales, avec des niveaux d'accès Internet très variables. Il ne s'agissait pas seulement de mettre en ligne des cours, mais de concevoir une expérience réellement accessible à une jeunesse aux profils très divers.
